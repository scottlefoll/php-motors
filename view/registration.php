            ...
            <main>
                ...
                <form method="post" action="/phpmotors/accounts/index.php" >
                    <fieldset>
                        ...
                        <label class="top" for="fname">First Name* <input type="text" id="fname" name="clientFirstname" <?php if(isset($clientFirstname)){echo "value='$clientFirstname'";} ?> maxlength="15" pattern = '^[A-Za-z -,.']{1,15}$'; required></label>
