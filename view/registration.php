            ...
            <main>
                ...
                <form method="post" action="/phpmotors/accounts/index.php" >
                    <fieldset>
                        ...
                        <input type="password" name="clientPassword" value="" pattern="^(?=^.{8,}$)(?=.*\d)(?=.*\W+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" id="password" placeholder="" required></label>
                        <label class="top" for="email">Email *<input type="email" id="email" <?php if(isset($clientFirstname)){echo "value='$clientEmail'";} ?> pattern="^.+@[^\.].*\.[a-z]{2,}$"  name="clientEmail" placeholder="someone@gmail.com" required></label>
