            ...
            <main>
                ...
                <form method="post" action= '/phpmotors/vehicles/index.php' >
                    <fieldset>
                        ...
                        <label class="top" for="invModel">Model*  <input type="text" id="title" name="invModel" <?php if(isset($invModel)){echo "value='$invModel'";} ?> placeholder="" pattern='^[A-Za-z -,.'0-9]{1,30}$' required></label>
                        <label class="top" for="invDescription">Description* <input type="invDescription" id="description" name="invDescription" <?php if(isset($invDescription)){echo "value='$invDescription'";} ?> placeholder='' pattern='^[A-Za-z0-9_ ?!\@#$%&*<>,.";:+=']{1,255}$' required></label>
                        <label class="top" for="invImage">Image*  <input type="text" id="img_filename" name="invImage" <?php if(isset($invImage)){echo "value='$invImage'";} else{echo "value='\PHPMotors\images\no-image.png'";} ?> placeholder='' pattern='^(?:[\w]\:|\\)(\\[a-z_\-\s0-9\.]+)+\.(gif|jpg|jpeg|png|gif|bmp)${6, 50}' required></label>
                        <label class="top" for="invThumbnail">Thumbnail* <input type="text" id="img_filename" name="invThumbnail"  <?php if(isset($invThumbnail)){echo "value='$invThumbnail'";}  else{echo "value='\PHPMotors\images\no-image.png'";} ?> placeholder='\PHPMotors\images\no-image.png' pattern='^(?:[\w]\:|\\)(\\[a-z_\-\s0-9\.]+)+\.(gif|jpg|jpeg|png|gif|bmp)${6, 50}' required></label>
                        ...
                        <label class="top" for="classificationId">Classification*</label>    
                            <select name="classificationId" id="classificationId" <?php if(isset($classificationId)){echo "value='$classificationId'";} ?> pattern='^\b([0-9]|1[0-9])\b$' required>
